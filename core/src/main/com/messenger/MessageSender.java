...
public class MessageSender extends Thread{
	...
	public void run() {
		try {
			logger.info("From Client : Connecting to " + destinationIP + " on port " + destinationPort);
			client = null;
			while(client==null)
			{
				...
				try{
					...
					logger.info("Port Not Found.Retrying....");
					Thread.sleep(1000);
				}
			}
			logger.info("From Client : Just connected to " + client.getRemoteSocketAddress());
//			
	...
	public void sendMessage(String message) throws IOException
	{
		...
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				AnotherController.allMessages.add(sender+" : "+messageToSend);

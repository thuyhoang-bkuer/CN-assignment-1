...
public class MessageSenderCopy extends Thread {
    ...
    Logger logger = LoggerFactory.getLogger(MessageSenderCopy.class);

    public MessageSenderCopy() {
    }

    public MessageSenderCopy(String destinationIP, int destinationPort) {
